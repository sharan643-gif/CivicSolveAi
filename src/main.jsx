    ...
    if (this.state.hasError) {
      return (
        <div style={{
          ...
          <p style={{ color: '#94a3b8', maxWidth: '480px', marginBottom: '24px', fontSize: '0.95rem' }}>
            An unexpected client initialization issue occurred. Please reload the page to reconnect.
          </p>
          <button
